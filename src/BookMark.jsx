...
function BookMark(){
    ...
    return(
        <div onClick={toggleMarked}>
        {isMarked ? (
           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" style={{height:"25px", width:"auto", fill:"white", position:"absolute", right:"0.7rem",bottom:"0.6rem"}}>
...
function Like(){
    ...
    return(
        <div onClick={toggleLiked}>
            {isliked ? (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style={{height:"25px", width:"auto", fill:"white"}}>
